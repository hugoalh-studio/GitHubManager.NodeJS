...
module.exports = function main() {
	...
	[
		...
		[`secret replace ...{repository/organization} ${chalk.bgMagenta.white.bold("W.I.P.")}`, `Replace all of the secrets from the local storage to the repository(ies) or organization(s).`]
	].forEach((element) => {
		tableCommandList.div(
			{
				text: `-`,
