...
module.exports = function main() {
	...
	[
		...
		[`label deletecross {name} ...{repository/localstorage}`, `Delete label in the repository(ies) or local storage.`],
		...
		[`secret deletecross {name} ...{repository/localstorage/organization}`, `Delete secret in the repository(ies), local storage, or organization(s).`],
...
${chalk.bgGray.white.bold("    GitHub Manager (@hugoalh-studio), v0.1.0    ")}
${chalk.bgGray(`                                                `)}
