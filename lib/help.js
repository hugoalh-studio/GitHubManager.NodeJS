...
module.exports = function main() {
	...
	[
		...
		[`secret delete {repository} ...{name}`, `Delete secret(s).`],
		[`secret deleteall ...{repository}`, `Delete all of the secrets.`],
		[`secret list {repository}`, `Alias of \`secret listmask {repository}\`.`],
		[`secret listmask {repository}`, `List all of the secrets with masked.`],
		[`secret listunmask {repository}`, `List all of the secrets without masked.`],
