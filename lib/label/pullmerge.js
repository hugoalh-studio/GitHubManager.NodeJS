...
async function local(targetData, sourceRepositories) {
...
async function network(targetRepository, targetData, sourceRepositories) {
...
async function main(targetRepository, ...sourceRepositories) {
	...
	if (targetRepository === "localstorage") {
		return local(targetData, sourceRepositoriesQueue);
	};
	return network(targetRepository, targetData, sourceRepositoriesQueue);
};
module.exports = main;
