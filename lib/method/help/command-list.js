const account = [
		...
		[`account lock {passpharse}`, `Protect the GitHub account's personal access token with an additional passpharse; Passpharse should not be the GitHub account's password, and must be at least 8 characters (case-sensitive).`],
		[`account sign-in {token}`, `Sign in a GitHub account via personal access token.`],
		[`account sign-out`, `Sign out this GitHub account.`],
		[`account unlock {passpharse}`, `Unprotect the GitHub account's personal access token with passpharse that previously setted (case-sensitive).`],
	...
	secret = [
		...
		[`secret lock {passpharse}`, `Protect the secret(s) with an additional passpharse; Passpharse must be at least 8 characters (case-sensitive).`],
		...
		[`secret unlock {passpharse}`, `Unprotect the secret(s) with passpharse that previously setted (case-sensitive).`]
	];
module.exports = {
	account,
	help,
